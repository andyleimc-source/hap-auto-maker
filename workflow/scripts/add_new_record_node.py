...
Typical usage:
    python3 scripts/add_new_record_node.py \\
        ...
        --fields '[
            {"fieldId":"69aead70c55060e1d97c80c6","type":2,"enumDefault":0,"fieldValue":"$69b4b9309c92de5d02cd9220-69aead70c55060e1d97c80c6$"},
            {"fieldId":"69aead70c55060e1d97c80c7","type":2,"enumDefault":0,"fieldValue":"$69b4b9309c92de5d02cd9220-69aead70c55060e1d97c80c7$"},
            {"fieldId":"69aead70c55060e1d97c80c8","type":9,"enumDefault":0,"fieldValue":"2209b24b-7ea1-43e2-99c6-8f1a2e2112bb"},
            {"fieldId":"69aead70c55060e1d97c80c9","type":2,"enumDefault":0,"fieldValue":""},
            {"fieldId":"69aead70c55060e1d97c80ca","type":2,"enumDefault":0,"fieldValue":"个"},
            {"fieldId":"69aead70c55060e1d97c80cb","type":6,"enumDefault":0,"fieldValue":"0"},
            {"fieldId":"69aead70c55060e1d97c80cc","type":14,"enumDefault":0,"fieldValue":""},
            {"fieldId":"69aead70c55060e1d97c80cd","type":2,"enumDefault":0,"fieldValue":""}
        ]' \\
        --publish

App: 家具生产订单管理 (c2259f27-8b27-4ecb-8def-10fdff5911d9)
Worksheet: 产品信息 (69aead6f952cd046bb57e3f2)
  Fields:
    69aead70c55060e1d97c80c6  产品SKU    type=2  (Text,   required)
    69aead70c55060e1d97c80c7  产品名称   type=2  (Text,   required)
    69aead70c55060e1d97c80c8  产品类别   type=9  (SingleSelect, required)
      options: 个人客户→23a61fe3 / 企业客户→f163a9f0 / 经销商→07d05ff3
      (产品类别 options 见下方 -- 用实际 option key 替换 fieldValue)
    69aead70c55060e1d97c80c9  规格尺寸   type=2  (Text,   required)
    69aead70c55060e1d97c80ca  单位       type=2  (Text,   required)
    69aead70c55060e1d97c80cb  标准单价   type=6  (Number, required)
    69aead70c55060e1d97c80cc  产品图纸   type=14 (Attachment, optional)
    69aead70c55060e1d97c80cd  备注信息   type=2  (Text,   optional)
    69aead72296f91d9c3fc50da  物料清单   type=29 (Relation, optional)
    69aead720514ba220ca76ba9  生产订单   type=29 (Relation, optional)

Other worksheets in this app:
  客户信息  69aead6fd777aea8806b9302
  产品信息  69aead6f952cd046bb57e3f2
  物料清单  69aead70952cd046bb57e400
  销售订单  69aead700514ba220ca76b89
  生产订单  69aead713b4d6c09e7a7d09c
  生产任务  69aead71d777aea8806b931e
  质量检验  69aead71ac7e8527a66d24b4

Field value formats:
  - Static text:       "hello"
  - Dynamic (from another node): "$<nodeId>-<fieldId>$"
  - Empty (leave blank): ""
  - SingleSelect: pass the option key (UUID) as fieldValue
  - Number:       pass numeric value as string, e.g. "0"
  - Relation:     use enumDefault=2, fieldValue="" (set in UI or via dynamic ref)
"""
...
def main() -> int:
    ...
    if not cookie:
        ...
        persist("add_new_record_node", None, args=log_args,
    ...
    persist("add_new_record_node", result, args=log_args, started_at=started_at, session=session)
    return 0
